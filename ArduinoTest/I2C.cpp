...
#define I2C_ACC_CALIBRATION_SCALE 7 // How much values to use for calibration (in powers of 2 -- 5 => 32)
...
#define I2C_GA_SMOOTHNESS_SCALE 2 // How much values (smoothness) to use for calculation (in powers of 2 -- 5 => 32).
